...
class Userlist extends Component {
    ...
    hasError(field) {
        console.log(field, this.state.errors.required[field] , !this.state.errors.valid[field], this.state.touched[field])
        return (this.state.errors.required[field] && !this.state.errors.valid[field] && this.state.touched[field])? true : false;
    }
                    ...
                    <Modal.Body>
                        ...
                        <Form.Group as={Row} controlId="name">
                          ...
                          <Col sm="10">
                            ...
                            <Col sm="12">
                                error: {this.hasError('name').toString()}
                                <div className={this.hasError('name') ? 'd-none' : 'd-block text-danger error-message'}>
                                    Name is required
                                </div>
                            </Col>
                        </Form.Group>
                        <Form.Group as={Row} controlId="username">
                          ...
                          <Col sm="10">
                            ...
                            <Col sm="12">
                                <div className={this.hasError('username') ? 'd-none' : 'd-block text-danger error-message'}>
                        ...
                        <Form.Group as={Row} controlId="email">
                          ...
                          <Col sm="10">
                            ...
                            <Col sm="12">
                                <div className={this.hasError('email') ? 'd-none' : 'd-block text-danger error-message'}>
                                    Email is required
                                </div>
                            </Col>
                        </Form.Group>
