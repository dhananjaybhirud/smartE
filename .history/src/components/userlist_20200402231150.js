        ...
        return ( <
            React.Fragment > {
                this.state.data.map((x, index) => {
                    ...
                    onClick = {
                            this.toggleModel.bind(this, true, index)
                        } > Edit < /Button></td >
                        <
                        /tr>
                })
            ...
            onHide = {
                this.handleClose.bind(this, false, '')
            } >
            <
            Form onSubmit = {
                this.handleSubmit
            ...
            <
            div className = {
                this.hasError('name') ? 'd-none' : 'd-block text-danger error-message'
            } >
            Name is required <
            /div> < /
            Col > <
            ...
            <
            div className = {
                this.hasError('username') ? 'd-none' : 'd-block text-danger error-message'
            } >
            ...
            <
            div className = {
                this.hasError('email') ? 'd-none' : 'd-block text-danger error-message'
            } >
            Email is required <
            /div> < /
            Col > <
